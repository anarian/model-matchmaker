...
3. Terminal window flashes briefly (~1 second), then closes
4. You press Enter to re-send with the new model
...
- Requires one extra Enter press after switch (gives you time to review your message)
